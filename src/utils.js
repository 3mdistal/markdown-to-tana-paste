...
exports.markdownToTanaPaste = void 0;
/**
 ...
 */
function markdownToTanaPaste(markdown) {
    const lines = markdown.split('\n');
    let tanaPaste = '%%tana%%\n';
    let outputLines = [];
    const headingLevelStack = []; // Tracks heading levels [1, 2]
    const listIndentStack = []; // Tracks char positions for lists
...
exports.markdownToTanaPaste = markdownToTanaPaste;
